						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div id="app">
								  ...
								  <base-input label="UnitPrice" type="text" placeholder="Enter UnitPrice" v-model="orderItemToAdd.unitPrice"></base-input>
												                  </form>
								                </div>
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Quantity</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Unit Price</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="UnitPrice" type="text" placeholder="Enter UnitPrice" v-model="orderItemDetails.unitPrice"></input>
																		</div>
						</td>
														</tr>
